...
g.fig.suptitle('Average Temperature', fontsize=15)
g.fig.supxlabel("Year", fontsize=15)
g.fig.supylabel("Average Temperature", fontsize=15)
g.fig.subplots_adjust(bottom=0.1)
g.fig.subplots_adjust(left=0.1)

plt.savefig("../plots/task5e1.png")
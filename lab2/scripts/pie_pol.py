...
def animation(df, outfile):
    ...
    def animate(i):
        ...
        ax.set_title("Population of 5 countries with closest population size to Poland in 2021, year "+str(1960+i), fontsize=18, fontweight='bold')
...
animation(df_poland, "../plots/pie_pol.gif")

...
def animation(df, outfile):
    ...
    def animate(i):    
        ...
        ax.set_xlabel("Five most populated countries in 2021", fontsize=18, fontweight='bold')
...
df_top = get_most_populated(filtered_df, 5)
animation(df_top, "../plots/bar_top_col.gif")
